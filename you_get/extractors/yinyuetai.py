...
def yinyuetai_download_by_id(vid, title=None, output_dir='.', merge=True, info_only=False, **kwargs):
...
def yinyuetai_download(url, output_dir='.', merge=True, info_only=False, **kwargs):
    ...
    yinyuetai_download_by_id(id, title, output_dir, merge=merge, info_only=info_only, **kwargs)
