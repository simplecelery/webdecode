...
#----------------------------------------------------------------------
def miaopai_download_by_smid(smid, output_dir = '.', merge = True, info_only = False, **kwargs):
    """"""
    ...
    if not info_only:
        return download_urls([video_url], title, ext, size, output_dir, merge=merge, **kwargs)

#----------------------------------------------------------------------
def yixia_miaopai_download_by_scid(scid, output_dir = '.', merge = True, info_only = False, **kwargs):
    """"""
...
#----------------------------------------------------------------------
def yixia_xiaokaxiu_download_by_scid(scid, output_dir = '.', merge = True, info_only = False, **kwargs):
    """"""
...
def yixia_download(url, output_dir = '.', merge = True, info_only = False, **kwargs):
    ...
    if 'n.miaopai.com' == hostname: 
        ...
        return miaopai_download_by_smid(smid, output_dir, merge, info_only, **kwargs)
    ...
    yixia_download_by_scid(scid, output_dir, merge, info_only, **kwargs)
