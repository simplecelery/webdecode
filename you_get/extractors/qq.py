...
def qq_download_by_vid(vid, title, output_dir='.', merge=True, info_only=False,**kwargs):
    ...
    if not info_only:
        return download_urls(part_urls, title, ext, total_size, output_dir=output_dir, merge=merge,**kwargs)
...
def qq_download(url, output_dir='.', merge=True, info_only=False, **kwargs):
    ...
    if 'mp.weixin.qq.com/s' in url:
        ...
        for vid in vids:
            qq_download_by_vid(vid, vid, output_dir, merge, info_only,**kwargs)
        return
    ...
    return qq_download_by_vid(vid, title, output_dir, merge, info_only,**kwargs)
