...
def veoh_download(url, output_dir = '.', merge = False, info_only = False, **kwargs):
    ...
    return veoh_download_by_id(item_id, output_dir = '.', merge = False, info_only = info_only, **kwargs)
...
def veoh_download_by_id(item_id, output_dir = '.', merge = False, info_only = False, **kwargs):
    ...
    if not info_only:
        return download_urls([url], title, ext, total_size=None, output_dir=output_dir, merge=merge, **kwarg)
