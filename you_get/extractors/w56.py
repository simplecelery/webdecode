...
def w56_download_by_id(id, title = None, output_dir = '.', merge = True, info_only = False, **kwargs):
...
def w56_download(url, output_dir = '.', merge = True, info_only = False, **kwargs):
    ...
    return w56_download_by_id(id, output_dir = output_dir, merge = merge, info_only = info_only, **kwargs)
